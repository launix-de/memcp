...
func init() {
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: unsupported compare const kind: nil:*github.com/launix-de/memcp/scm.Proc */, /* TODO: unsupported compare const kind: nil:*github.com/launix-de/memcp/scm.Proc */
	})
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: unresolved SSA value: github.com/launix-de/memcp/scm.Globalenv */, /* TODO: unresolved SSA value: github.com/launix-de/memcp/scm.Globalenv */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: FieldAddr on non-receiver: &b.addr [#0] */, /* TODO: FieldAddr on non-receiver: &b.addr [#0] */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: FieldAddr on non-receiver: &t7.ptr [#0] */, /* TODO: FieldAddr on non-receiver: &t7.ptr [#0] */
	})
	Declare(&Globalenv, &Declaration{
...
`,
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: FieldAddr on non-receiver: &t0.source [#0] */, /* TODO: FieldAddr on non-receiver: &t0.source [#0] */
	})
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: IndexAddr on non-parameter: &t0[0:int] */, /* TODO: IndexAddr on non-parameter: &t0[0:int] */
	})
	Declare(&Globalenv, &Declaration{
