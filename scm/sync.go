...
func init_sync() {
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: unsupported compare const kind: nil:*github.com/jtolds/gls.ContextManager */, /* TODO: unsupported compare const kind: nil:*github.com/jtolds/gls.ContextManager */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: unresolved SSA value: github.com/launix-de/memcp/scm.cachedStatsMu */, /* TODO: unresolved SSA value: github.com/launix-de/memcp/scm.cachedStatsMu */
	})
}
