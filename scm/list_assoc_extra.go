		...
		Type: &TypeDescriptor{Kind: "func", Description: "groups list elements by key and reduces every group from a neutral value",
			...
			JITEmit: func(ctx *JITContext, sourceArgs []Scmer, args []JITValueDesc, result JITValueDesc) JITValueDesc {
				...
				bbs[2].RenderPS = func(ps PhiState) JITValueDesc {
					...
					d59 = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(callbackResultOff60), ID: 0}
					ctx.FreeDesc(&d56)
					ctx.StabilizeDescAcrossNestedCall(&d23)
					if d7.Loc == LocLambdaTemplate && d7.Lambda != nil {
						stableCallbackArgs61 := ctx.StabilizeCallbackArgs(callbackArgs58)
						ctx.ReclaimUntrackedRegs()
						outerRegs62 := ctx.PreserveOuterRegsExcept(jitDescRegs(d59)...)
						d57 = JITEmitProcInlineWithOuter(ctx, &d7.Lambda.Proc, d7.Lambda.Outer, stableCallbackArgs61, ctx.SliceBase, d59)
						ctx.RestoreOuterRegs(outerRegs62)
						ctx.ReclaimUntrackedRegs()
					} else {
						d63, knownBuiltin64 := jitEmitKnownDeclaration(ctx, d7, callbackArgs58, d59)
						if knownBuiltin64 {
							d57 = d63
						} else {
							ctx.Coverage.DynamicCalls++
							d65 := jitCopyScmerToPair(ctx, d7)
							d57 = jitEmitDynamicCallableAt(ctx, d65, callbackArgs58, int32(stackArray55), d59)
						}
					}
					d66 = args[3]
					d66.ID = 0
					...
					ctx.SyncDesc(&d66)
					ctx.SyncDesc(&d10)
					ctx.EmitGoCallVoid(GoFuncAddr((*FastDict).ReduceValue), []JITValueDesc{d18, d57, d53, d66, d10})
					ctx.FreeDesc(&d57)
					ctx.FreeDesc(&d53)
					ctx.FreeDesc(&d66)
					if ps.General {
					...
					ps68.PhiValues = make([]JITValueDesc, 1)
					d69 = d23
					ps68.PhiValues[0] = d69
					if ps68.General && bbs[1].Rendered {
						ctx.EmitJmp(lbl2)
						return result
					}
				...
				bbs[3].RenderPS = func(ps PhiState) JITValueDesc {
					...
					if d18.Loc == LocImm {
						...
						d70 = JITValueDesc{Loc: LocRegPair, Type: tagFastDict, Reg: d18.Reg, Reg2: r7}
						ctx.BindReg(d18.Reg, &d70)
						ctx.BindReg(r7, &d70)
					...
					if d70.Loc == LocRegPair || d70.Loc == LocStackPair || d70.Loc == LocInputPair {
						...
						case tagBool:
							...
							result.Type = tagBool
						case tagInt:
							ctx.EmitMakeInt(result, d70)
							result.Type = tagInt
						case tagFloat:
							ctx.EmitMakeFloat(result, d70)
		...
		Type: &TypeDescriptor{Kind: "func", Description: "optimizer-only append reduction into grouped lists",
			...
			JITEmit: func(ctx *JITContext, sourceArgs []Scmer, args []JITValueDesc, result JITValueDesc) JITValueDesc {
				...
				bbs[2].RenderPS = func(ps PhiState) JITValueDesc {
					...
					d71 = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(callbackResultOff72), ID: 0}
					ctx.FreeDesc(&d68)
					ctx.StabilizeDescAcrossNestedCall(&d23)
					if d10.Loc == LocLambdaTemplate && d10.Lambda != nil {
						stableCallbackArgs73 := ctx.StabilizeCallbackArgs(callbackArgs70)
						ctx.ReclaimUntrackedRegs()
						outerRegs74 := ctx.PreserveOuterRegsExcept(jitDescRegs(d71)...)
						d69 = JITEmitProcInlineWithOuter(ctx, &d10.Lambda.Proc, d10.Lambda.Outer, stableCallbackArgs73, ctx.SliceBase, d71)
						ctx.RestoreOuterRegs(outerRegs74)
						ctx.ReclaimUntrackedRegs()
					} else {
						d75, knownBuiltin76 := jitEmitKnownDeclaration(ctx, d10, callbackArgs70, d71)
						if knownBuiltin76 {
							d69 = d75
						} else {
							ctx.Coverage.DynamicCalls++
							d77 := jitCopyScmerToPair(ctx, d10)
							d69 = jitEmitDynamicCallableAt(ctx, d77, callbackArgs70, int32(stackArray67), d71)
						}
					}
					ctx.EnsureDesc(&d18)
					ctx.EnsureDesc(&d18)
					...
					ctx.SyncDesc(&d57)
					ctx.SyncDesc(&d69)
					ctx.EmitGoCallVoid(GoFuncAddr((*FastDict).AppendValue), []JITValueDesc{d18, d57, d69})
					ctx.FreeDesc(&d57)
					ctx.FreeDesc(&d69)
					if ps.General {
						ctx.SyncDesc(&d23)
				...
				bbs[3].RenderPS = func(ps PhiState) JITValueDesc {
					...
					if d18.Loc == LocImm {
						...
						r7 := ctx.AllocReg()
						ctx.EmitMovRegImm64(r7, makeAux(tagFastDict, 0))
						d81 = JITValueDesc{Loc: LocRegPair, Type: tagFastDict, Reg: d18.Reg, Reg2: r7}
						ctx.BindReg(d18.Reg, &d81)
						ctx.BindReg(r7, &d81)
						ctx.TransferReg(d18.Reg)
						ctx.BindReg(d18.Reg, &d81)
						ctx.BindReg(r7, &d81)
		...
		Type: &TypeDescriptor{Kind: "func", Description: "optimizer-only append reduction from a normalized two-parameter reducer",
			...
			JITEmit: func(ctx *JITContext, sourceArgs []Scmer, args []JITValueDesc, result JITValueDesc) JITValueDesc {
				...
				bbs[2].RenderPS = func(ps PhiState) JITValueDesc {
					...
					ctx.PrepareScmerStackTarget(int32(callbackResultOff61))
					d60 = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(callbackResultOff61), ID: 0}
					ctx.FreeDesc(&d57)
					ctx.StabilizeDescAcrossNestedCall(&d23)
					if d7.Loc == LocLambdaTemplate && d7.Lambda != nil {
						stableCallbackArgs62 := ctx.StabilizeCallbackArgs(callbackArgs59)
						ctx.ReclaimUntrackedRegs()
						outerRegs63 := ctx.PreserveOuterRegsExcept(jitDescRegs(d60)...)
						d58 = JITEmitProcInlineWithOuter(ctx, &d7.Lambda.Proc, d7.Lambda.Outer, stableCallbackArgs62, ctx.SliceBase, d60)
						ctx.RestoreOuterRegs(outerRegs63)
						ctx.ReclaimUntrackedRegs()
					} else {
						d64, knownBuiltin65 := jitEmitKnownDeclaration(ctx, d7, callbackArgs59, d60)
						if knownBuiltin65 {
							d58 = d64
						} else {
							ctx.Coverage.DynamicCalls++
							d66 := jitCopyScmerToPair(ctx, d7)
							d58 = jitEmitDynamicCallableAt(ctx, d66, callbackArgs59, int32(stackArray56), d60)
						}
					}
					d67 = JITValueDesc{Loc: LocImm, Type: tagNil, Imm: NewNil()}
					stackArray68 = ctx.AllocStack(int32(32))
					_ = stackArray68
					ctx.SyncDesc(&d67)
					ctx.EmitStoreScmerToStack(d67, int32(stackArray68)+int32(0))
					ctx.FreeDesc(&d67)
					ctx.SyncDesc(&d53)
					ctx.EmitStoreScmerToStack(d53, int32(stackArray68)+int32(16))
					ctx.FreeDesc(&d53)
					d69 = JITValueDesc{Loc: LocVirtualSlice, Type: tagSlice, KnownSliceLen: int32(2), KnownSliceCap: int32(2), SliceSizeKnown: true}
					_ = d69
					callbackArgs71 := make([]JITValueDesc, 2)
					callbackArgs71[0] = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(stackArray68) + 0}
					callbackArgs71[1] = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(stackArray68) + 16}
					var d70 JITValueDesc
					var d72 JITValueDesc
					callbackResultOff73 = ctx.AllocStack(16)
					ctx.PrepareScmerStackTarget(int32(callbackResultOff73))
					d72 = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(callbackResultOff73), ID: 0}
					ctx.FreeDesc(&d69)
					ctx.StabilizeDescAcrossNestedCall(&d23)
					if d10.Loc == LocLambdaTemplate && d10.Lambda != nil {
						stableCallbackArgs74 := ctx.StabilizeCallbackArgs(callbackArgs71)
						ctx.ReclaimUntrackedRegs()
						outerRegs75 := ctx.PreserveOuterRegsExcept(jitDescRegs(d72)...)
						d70 = JITEmitProcInlineWithOuter(ctx, &d10.Lambda.Proc, d10.Lambda.Outer, stableCallbackArgs74, ctx.SliceBase, d72)
						ctx.RestoreOuterRegs(outerRegs75)
						ctx.ReclaimUntrackedRegs()
					} else {
						d76, knownBuiltin77 := jitEmitKnownDeclaration(ctx, d10, callbackArgs71, d72)
						if knownBuiltin77 {
							d70 = d76
						} else {
							ctx.Coverage.DynamicCalls++
							d78 := jitCopyScmerToPair(ctx, d10)
							d70 = jitEmitDynamicCallableAt(ctx, d78, callbackArgs71, int32(stackArray68), d72)
						}
					}
					ctx.EnsureDesc(&d18)
					ctx.EnsureDesc(&d18)
					...
					ctx.SyncDesc(&d58)
					ctx.SyncDesc(&d70)
					ctx.EmitGoCallVoid(GoFuncAddr((*FastDict).AppendValue), []JITValueDesc{d18, d58, d70})
					ctx.FreeDesc(&d58)
					ctx.FreeDesc(&d70)
					if ps.General {
						ctx.SyncDesc(&d23)
				...
				bbs[3].RenderPS = func(ps PhiState) JITValueDesc {
					...
					if d18.Loc == LocImm {
						...
						r7 := ctx.AllocReg()
						ctx.EmitMovRegImm64(r7, makeAux(tagFastDict, 0))
						d82 = JITValueDesc{Loc: LocRegPair, Type: tagFastDict, Reg: d18.Reg, Reg2: r7}
						ctx.BindReg(d18.Reg, &d82)
						ctx.BindReg(r7, &d82)
						ctx.TransferReg(d18.Reg)
						ctx.BindReg(d18.Reg, &d82)
						ctx.BindReg(r7, &d82)
		...
		Type: &TypeDescriptor{Kind: "func", Description: "optimizer-only integer counting reduction by key",
			...
			JITEmit: func(ctx *JITContext, sourceArgs []Scmer, args []JITValueDesc, result JITValueDesc) JITValueDesc {
				...
				bbs[2].RenderPS = func(ps PhiState) JITValueDesc {
					...
					d54 = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(callbackResultOff55), ID: 0}
					ctx.FreeDesc(&d51)
					ctx.StabilizeDescAcrossNestedCall(&d20)
					if d7.Loc == LocLambdaTemplate && d7.Lambda != nil {
						stableCallbackArgs56 := ctx.StabilizeCallbackArgs(callbackArgs53)
						ctx.ReclaimUntrackedRegs()
						outerRegs57 := ctx.PreserveOuterRegsExcept(jitDescRegs(d54)...)
						d52 = JITEmitProcInlineWithOuter(ctx, &d7.Lambda.Proc, d7.Lambda.Outer, stableCallbackArgs56, ctx.SliceBase, d54)
						ctx.RestoreOuterRegs(outerRegs57)
						ctx.ReclaimUntrackedRegs()
					} else {
						d58, knownBuiltin59 := jitEmitKnownDeclaration(ctx, d7, callbackArgs53, d54)
						if knownBuiltin59 {
							d52 = d58
						} else {
							ctx.Coverage.DynamicCalls++
							d60 := jitCopyScmerToPair(ctx, d7)
							d52 = jitEmitDynamicCallableAt(ctx, d60, callbackArgs53, int32(stackArray50), d54)
						}
					}
					ctx.EnsureDesc(&d15)
					ctx.EnsureDesc(&d15)
		...
		Type: &TypeDescriptor{Kind: "func", Description: "optimizer-only counting from a normalized two-parameter reducer",
			...
			JITEmit: func(ctx *JITContext, sourceArgs []Scmer, args []JITValueDesc, result JITValueDesc) JITValueDesc {
				...
				bbs[2].RenderPS = func(ps PhiState) JITValueDesc {
					...
					d55 = JITValueDesc{Loc: LocStackPair, Type: JITTypeUnknown, StackOff: int32(callbackResultOff56), ID: 0}
					ctx.FreeDesc(&d52)
					ctx.StabilizeDescAcrossNestedCall(&d20)
					if d7.Loc == LocLambdaTemplate && d7.Lambda != nil {
						stableCallbackArgs57 := ctx.StabilizeCallbackArgs(callbackArgs54)
						ctx.ReclaimUntrackedRegs()
						outerRegs58 := ctx.PreserveOuterRegsExcept(jitDescRegs(d55)...)
						d53 = JITEmitProcInlineWithOuter(ctx, &d7.Lambda.Proc, d7.Lambda.Outer, stableCallbackArgs57, ctx.SliceBase, d55)
						ctx.RestoreOuterRegs(outerRegs58)
						ctx.ReclaimUntrackedRegs()
					} else {
						d59, knownBuiltin60 := jitEmitKnownDeclaration(ctx, d7, callbackArgs54, d55)
						if knownBuiltin60 {
							d53 = d59
						} else {
							ctx.Coverage.DynamicCalls++
							d61 := jitCopyScmerToPair(ctx, d7)
							d53 = jitEmitDynamicCallableAt(ctx, d61, callbackArgs54, int32(stackArray51), d55)
						}
					}
					ctx.EnsureDesc(&d15)
					ctx.EnsureDesc(&d15)
				...
				bbs[3].RenderPS = func(ps PhiState) JITValueDesc {
					...
					if d15.Loc == LocImm {
						...
						r7 := ctx.AllocReg()
						ctx.EmitMovRegImm64(r7, makeAux(tagFastDict, 0))
						d65 = JITValueDesc{Loc: LocRegPair, Type: tagFastDict, Reg: d15.Reg, Reg2: r7}
						ctx.BindReg(d15.Reg, &d65)
						ctx.BindReg(r7, &d65)
						ctx.TransferReg(d15.Reg)
						ctx.BindReg(d15.Reg, &d65)
						ctx.BindReg(r7, &d65)
