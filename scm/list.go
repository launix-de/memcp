...
func init_list() {
	...
	Declare(&Globalenv, &Declaration{
		...
		true, true, &TypeDescriptor{},
		nil /* TODO: MakeClosure with 3 bindings */,
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: IndexAddr on non-parameter: &t7[0:int] (x=t7 marker="_alloc" isDesc=false goVar=) */,
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: IndexAddr on non-parameter: &t12[0:int] (x=t12 marker="_alloc" isDesc=false goVar=) */,
	})
	...
	Declare(&Globalenv, &Declaration{
		...
		true, true, &TypeDescriptor{Return: FreshAlloc},
		nil /* TODO: IndexAddr on non-parameter: &t14[0:int] (x=t14 marker="_alloc" isDesc=false goVar=) */,
	})
	...
	Declare(&Globalenv, &Declaration{
		...
		true, true, &TypeDescriptor{Return: FreshAlloc},
		nil /* TODO: IndexAddr on non-parameter: &t13[0:int] (x=t13 marker="_alloc" isDesc=false goVar=) */,
	})
