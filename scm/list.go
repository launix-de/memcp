...
func init_list() {
	...
	Declare(&Globalenv, &Declaration{
		...
		true, false, nil,
		nil /* TODO: unsupported compare const kind: nil:*github.com/launix-de/memcp/scm.FastDict */, /* TODO: unsupported compare const kind: nil:*github.com/launix-de/memcp/scm.FastDict */ /* TODO: unsupported compare const kind: nil:*github.com/launix-de/memcp/scm.FastDict */ /* TODO: unsupported compare const kind: nil:*github.com/launix-de/memcp/scm.FastDict */
	})
	Declare(&Globalenv, &Declaration{
		...
		true, false, nil,
		nil /* TODO: Slice on non-desc: slice t1[:] */, /* TODO: Slice on non-desc: slice t1[:] */ /* TODO: Slice on non-desc: slice t1[:] */ /* TODO: Slice on non-desc: slice t1[:] */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: Slice on non-desc: slice t0[:] */, /* TODO: Slice on non-desc: slice t0[:] */ /* TODO: Slice on non-desc: slice t0[:] */ /* TODO: Slice on non-desc: slice t0[:] */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: IndexAddr on non-parameter: &t14[0:int] */, /* TODO: IndexAddr on non-parameter: &t14[0:int] */ /* TODO: IndexAddr on non-parameter: &t14[0:int] */ /* TODO: IndexAddr on non-parameter: &t14[0:int] */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		true, false, &TypeDescriptor{Return: FreshAlloc},
		nil /* TODO: phi edge references unknown value: parameter a : []Scmer */, /* TODO: phi edge references unknown value: parameter a : []Scmer */ /* TODO: phi edge references unknown value: parameter a : []Scmer */ /* TODO: phi edge references unknown value: parameter a : []Scmer */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		true, false, &TypeDescriptor{Return: FreshAlloc},
		nil /* TODO: Slice on non-desc: slice t0[:0:int] */, /* TODO: Slice on non-desc: slice t0[:0:int] */ /* TODO: Slice on non-desc: slice t0[:0:int] */ /* TODO: Slice on non-desc: slice t0[:0:int] */
	})
	Declare(&Globalenv, &Declaration{
		...
		true, false, &TypeDescriptor{Return: FreshAlloc},
		nil /* TODO: MakeSlice: make []Scmer t5 t5 */, /* TODO: MakeSlice: make []Scmer t5 t5 */ /* TODO: MakeSlice: make []Scmer t5 t5 */ /* TODO: MakeSlice: make []Scmer t5 t5 */
	})
	Declare(&Globalenv, &Declaration{
		...
		true, false, nil,
		nil /* TODO: unresolved SSA value: false:bool */, /* TODO: unresolved SSA value: false:bool */ /* TODO: unresolved SSA value: false:bool */ /* TODO: unresolved SSA value: false:bool */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: Slice on non-desc: slice t1[:0:int] */, /* TODO: Slice on non-desc: slice t1[:0:int] */ /* TODO: Slice on non-desc: slice t1[:0:int] */ /* TODO: Slice on non-desc: slice t1[:0:int] */
	})
	Declare(&Globalenv, &Declaration{
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: FieldAddr on non-receiver: &Globalenv.Vars [#0] */, /* TODO: FieldAddr on non-receiver: &Globalenv.Vars [#0] */ /* TODO: FieldAddr on non-receiver: &Globalenv.Vars [#0] */ /* TODO: FieldAddr on non-receiver: &Globalenv.Vars [#0] */
	})
	...
	Declare(&Globalenv, &Declaration{
		...
		nil /* TODO: unsupported builtin: SliceData */, /* TODO: unsupported builtin: SliceData */ /* TODO: unsupported builtin: SliceData */ /* TODO: unsupported builtin: SliceData */
	})
