...
func (s *StorageSparse) JITEmit(ctx *scm.JITContext, thisptr scm.JITValueDesc, idx scm.JITValueDesc, result scm.JITValueDesc) scm.JITValueDesc {
	...
	/* DO NEVER MANUALLY EDIT THIS SECTION. RUN make jitgen TO UPDATE */
			...
			if d20.Loc == scm.LocImm {
				...
				ctx.EmitShlRegImm8(d20.Reg, 32)
				ctx.EmitShrRegImm8(d20.Reg, 32)
			}
			...
			if d23.Loc == scm.LocImm && d25.Loc == scm.LocImm {
				...
				ctx.EmitMovRegReg(r17, d23.Reg)
				ctx.EmitImulInt64(r17, d25.Reg)
			...
			if d28.Loc == scm.LocImm {
				ctx.EmitMovRegImm64(r20, uint64(d28.Imm.Int()) * 8)
			} else {
			...
			if d29.Loc == scm.LocImm && d30.Loc == scm.LocImm {
				...
				ctx.EmitShlRegImm8(r23, uint8(d30.Imm.Int()))
			...
			if d38.Loc == scm.LocImm && d37.Loc == scm.LocImm {
				...
				ctx.EmitMovRegReg(r29, d38.Reg)
				ctx.EmitSubInt64(r29, d37.Reg)
			...
			if d22.Loc == scm.LocImm && d39.Loc == scm.LocImm {
				...
				ctx.EmitMovRegReg(r30, d22.Reg)
				ctx.EmitShrRegImm8(r30, uint8(d39.Imm.Int()))
			...
			if d41.Loc == scm.LocImm && d43.Loc == scm.LocImm {
				...
				ctx.EmitMovRegReg(r37, d41.Reg)
				ctx.EmitAddInt64(r37, d43.Reg)
			...
			if d44.Loc == scm.LocImm {
				...
				ctx.EmitCmpRegImm32(d44.Reg, 64)
			...
			if d50.Loc == scm.LocImm {
				ctx.EmitMovRegImm64(r40, uint64(d50.Imm.Int()) * 8)
			} else {
			...
			if d53.Loc == scm.LocImm && d52.Loc == scm.LocImm {
				...
				ctx.EmitSubInt64(scratch, d52.Reg)
				...
				if d52.Imm.Int() >= -2147483648 && d52.Imm.Int() <= 2147483647 {
					ctx.EmitSubRegImm32(scratch, int32(d52.Imm.Int()))
				} else {
				...
				ctx.EmitMovRegReg(r44, d53.Reg)
				ctx.EmitSubInt64(r44, d52.Reg)
			...
			if d51.Loc == scm.LocImm && d54.Loc == scm.LocImm {
				...
				ctx.EmitShrRegImm8(r45, uint8(d54.Imm.Int()))
			...
			if d31.Loc == scm.LocImm && d55.Loc == scm.LocImm {
				...
				ctx.EmitMovRegReg(r48, d31.Reg)
				if d55.Imm.Int() >= -2147483648 && d55.Imm.Int() <= 2147483647 {
					ctx.EmitOrRegImm32(r48, int32(d55.Imm.Int()))
				} else {
				...
				ctx.EmitMovRegReg(r49, d31.Reg)
				ctx.EmitOrInt64(r49, d55.Reg)
			...
			if d58.Loc == scm.LocImm && d60.Loc == scm.LocImm {
				...
				ctx.EmitMovRegReg(r53, d58.Reg)
				ctx.EmitAddInt64(r53, d60.Reg)
			...
			if d61.Loc == scm.LocImm && d62.Loc == scm.LocImm {
				...
				ctx.EmitCmpInt64(scm.RegR11, d62.Reg)
			...
			ctx.EnsureDesc(&d71)
			if d20.Loc == scm.LocImm {
				ctx.EmitMovRegImm64(r62, uint64(d20.Imm.Int()) * 16)
			} else {
				ctx.EmitMovRegReg(r62, d20.Reg)
			...
			if d61.Loc == scm.LocImm && d74.Loc == scm.LocImm {
				...
				if d74.Imm.Int() >= -2147483648 && d74.Imm.Int() <= 2147483647 {
					ctx.EmitCmpRegImm32(d61.Reg, int32(d74.Imm.Int()))
				} else {
				...
				ctx.EmitCmpInt64(d61.Reg, d74.Reg)
			...
			if d83.Loc == scm.LocImm {
				...
				ctx.EmitShlRegImm8(d83.Reg, 32)
				ctx.EmitShrRegImm8(d83.Reg, 32)
			}
			...
			if d85.Loc == scm.LocImm {
				...
				ctx.EmitShlRegImm8(d85.Reg, 32)
				ctx.EmitShrRegImm8(d85.Reg, 32)
			}
			...
			if d87.Loc == scm.LocImm {
				...
				ctx.EmitShlRegImm8(d87.Reg, 32)
				ctx.EmitShrRegImm8(d87.Reg, 32)
			}
			...
			if d92.Loc == scm.LocImm {
				...
				ctx.EmitShlRegImm8(d92.Reg, 32)
				ctx.EmitShrRegImm8(d92.Reg, 32)
			}
			...
			if d94.Loc == scm.LocImm {
				...
				ctx.EmitShlRegImm8(d94.Reg, 32)
				ctx.EmitShrRegImm8(d94.Reg, 32)
			}
