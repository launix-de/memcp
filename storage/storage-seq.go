...
func (s *StorageSeq) JITEmit(ctx *scm.JITContext, thisptr scm.JITValueDesc, idx scm.JITValueDesc, result scm.JITValueDesc) scm.JITValueDesc {
			...
			ctx.FreeDesc(&d149)
			ctx.FreeDesc(&d151)
			// d152 (stride) must survive the long recordId extraction; protect it from eviction
			if d152.Loc == scm.LocReg {
