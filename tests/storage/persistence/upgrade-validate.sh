...
def capture():
    ...
    for name in names:
        ...
        for fields in metadata[1:]:
            ...
            # Planner-owned temporary projections are reconstructible cache
            # artifacts, not part of the application-data oracle. Their public
            # behaviour is covered by the repeated SQL query oracle.
