...
(define parse_psql (lambda (schema s policy) (begin
	...
	(define p (parser (or
		...
		(parser '((atom "DESCRIBE" true) (define schema2 psql_identifier) (atom "." true) (define id psql_identifier)) '((quote map) '((quote show) schema2 id) '((quote lambda) '((quote line)) '((quote resultrow) (quote line)))))
