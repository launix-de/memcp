...
(define parse_sql (lambda (schema s policy planning_session tx) (begin
	...
	(define sql_create_table (parser '(
		...
		(define options (* (or
			...
			(parser '((atom "ENGINE" true) "=" (atom "LOGGED" true)) '("engine" "logged"))
	...
	(define sql_alter_table (parser '(
		...
		(define alters (+ (or
			...
			(parser '((atom "ADD" true) (? (atom "CONSTRAINT" true) (define cname (? sql_identifier))) (atom "FOREIGN" true) (atom "KEY" true) (? (define fkname sql_identifier)) "(" (define cols1 (+ sql_identifier ",")) ")" (atom "REFERENCES" true) (define tbl2 sql_identifier) "(" (define cols2 (+ sql_identifier ",")) ")" (? (atom "ON" true) (atom "UPDATE" true) (define updatemode sql_foreign_key_mode)) (? (atom "ON" true) (atom "DELETE" true) (define deletemode sql_foreign_key_mode))) (lambda (id) '('createforeignkey '('table schema id) (coalesce cname fkname (concat id "_" (car cols1) "_fk")) (cons (quote list) cols1) '('table schema tbl2) (cons (quote list) cols2) updatemode deletemode)))
			(parser '((atom "DROP" true) (atom "FOREIGN" true) (atom "KEY" true) (define fk sql_identifier)) (lambda (id) '('dropforeignkey '('table schema id) fk)))
			(parser '((atom "DROP" true) (atom "CONSTRAINT" true) (define fk sql_identifier)) (lambda (id) '('or '('dropforeignkey '('table schema id) fk) '('dropkey '('table schema id) fk))))
	...
	(define p (parser (or
		...
		(parser '((atom "SHOW" true) (? (atom "FULL" true)) (atom "COLUMNS" true) (atom "FROM" true) (define id sql_identifier) (? (atom "WHERE" true) (define where sql_expression))) (begin
			...
			(if (nil? where)
				'((quote map) '((quote show) schema id) '((quote lambda) '((quote line)) '((quote resultrow) (quote line))))
